...
def check_connection(network, first, second):
    ...
    for list in networks:
        if first in list:
            for item in list:
                if item != first and item not in first_fr:
                    first_fr.append(item)
    for friend in first_fr:
        for list in networks:
            if friend in list:
                for item in list:
                    if item != friend and item not in first_fr:
                        first_fr.append(item)
    if second in first_fr:
        return True
    else:
        return False
