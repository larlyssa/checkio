...
def checkio(game_result):
    #return "D" or "X" or "O"
    if game_result[0][0] == "X" and game_result[1][0] == "X" and game_result[2][0] == "X":
        return "X"
    if game_result[0][1] == "X" and game_result[1][1] == "X" and game_result[2][1] == "X":
        return "X"
    if game_result[0][2] == "X" and game_result[1][2] == "X" and game_result[2][2] == "X":
        return "X"
        
    if game_result[0][0] == "X" and game_result[0][1] == "X" and game_result[0][2] == "X":
        return "X"
    if game_result[1][0] == "X" and game_result[1][1] == "X" and game_result[1][2] == "X":
        return "X"
    if game_result[2][0] == "X" and game_result[2][1] == "X" and game_result[2][2] == "X":
        return "X"
    ...
    if game_result[0][0] == "O" and game_result[1][0] == "O" and game_result[2][0] == "O":
        return "O"
    if game_result[0][1] == "O" and game_result[1][1] == "O" and game_result[2][1] == "O":
        return "O"
    if game_result[0][2] == "O" and game_result[1][2] == "O" and game_result[2][2] == "O":
        return "O"
        
    if game_result[0][0] == "O" and game_result[0][1] == "O" and game_result[0][2] == "O":
        return "O"
    if game_result[1][0] == "O" and game_result[1][1] == "O" and game_result[1][2] == "O":
        return "O"
    if game_result[2][0] == "O" and game_result[2][1] == "O" and game_result[2][2] == "O":
        return "O"
