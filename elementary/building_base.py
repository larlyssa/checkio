...
class Building:
    ...
    def corners(self):
        corner_coords = {"north-west": [self.north, self.west], "north-east": [self.north, self.east], "south-west": [self.south, self.west], "south-east": [self.south, self.east]}
    ...
    def __repr__(self):
        building_str = "Building(" + str(self.south) + ", " + str(self.west) + ", " + str(self.width_WE) + ", " + str(self.width_NS) + ", " + str(self.height) + ")"
        return building_str
