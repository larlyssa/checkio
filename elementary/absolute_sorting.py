...
def checkio(numbers_array):
    ...
    while count < len(numbers_array):
        if abs(numbers_array[count - 1]) > abs(numbers_array[count]):
            numbers_array[count - 1], numbers_array[count] = numbers_array[count], numbers_array[count - 1]
            count = 0
        count += 1
